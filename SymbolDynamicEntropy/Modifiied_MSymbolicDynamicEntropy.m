function [MSDE]=Modifiied_MSymbolicDynamicEntropy(PartitionData,Data,numSymbol,Depth,Scale)
...
for i=1:Scale
    ...
    Multi_Data=Multi(Data,Scale,2);
    symbolSeq=SymbolGeneration(Multi_Data,partition);
    MSDE(i)=NormalSymbolicDynamicEntropy(symbolSeq, numSymbol, Depth);
end
end
